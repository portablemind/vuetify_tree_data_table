  ...
  methods: {
    ...
    */
    ...
    dragEnterLeaf(event) {
      ...
      if (this.draggedNode) {
        if (this.draggedNode.parentNode && $target.parents('.leaf').attr('id') != this.draggedNode.parentNode.id && $target.parents('.leaf').attr('id') != this.draggedNode.id) {
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2933321a", Component.options)
  } else {
    hotAPI.reload("data-v-2933321a", Component.options)
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2933321a", { render: render, staticRenderFns: staticRenderFns })
  }
}
